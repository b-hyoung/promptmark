...
class RecommendServiceTest {
    ...
    void short_message_returns_rule_fallback_immediately() {
        ...
        RecommendService svc = new RecommendService(assetDao, tagDao, embed,
    ...
    void llm_disabled_uses_rule_fallback() {
        ...
        RecommendService svc = new RecommendService(assetDao, tagDao,
    ...
    void rule_fallback_with_results_uses_first_title() {
        AssetCard card = new AssetCard(1, "PROMPT", "자기소개서 첨삭", "...", 0,
