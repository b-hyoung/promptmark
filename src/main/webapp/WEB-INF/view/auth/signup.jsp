...
<c:set var="pageTitle"><fmt:message key="nav.signup"/> — promptmark</c:set>
<%@ include file="/WEB-INF/view/layout/header.jsp" %>

<section class="auth-form">
  <h1><fmt:message key="nav.signup"/></h1>
  ...
  <form method="post" action="${pageContext.request.contextPath}/app/auth/signup" novalidate>
    ...
    <div class="field">
      <label for="password_confirm"><fmt:message key="auth.password_confirm"/></label>
    ...
    <div class="field">
      <label for="nickname"><fmt:message key="auth.nickname"/></label>
    ...
    <div class="field">
      <label for="role"><fmt:message key="auth.role"/></label>
    ...
    <button type="submit"><fmt:message key="auth.signup_submit"/></button>
  </form>

  <p><a href="${pageContext.request.contextPath}/app/auth/login">이미 계정이 있으신가요? <fmt:message key="nav.login"/></a></p>
</section>
